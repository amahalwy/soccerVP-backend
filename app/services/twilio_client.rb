...
module TwilioClient
  ...
  def self.client
    account_sid = Rails.env["development"] ? Rails.application.credentials.twilio_account_sid : ENV["TWILIO_ACCOUNT_SID"]
    auth_token = Rails.env["development"] ? Rails.application.credentials.twilio_auth_token : ENV["TWILIO_AUTH_TOKEN"]
